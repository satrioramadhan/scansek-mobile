                    ...
                    if (controller.bmi.value != null && 
                      ...
                      return Column(
                        children: [
                          ...
                          if (controller.isStabilizationPhase) ...[
                                ...
                                Container(
                                  ...
                                  child: Row(
                                    children: [
                                      ...
                                      Text(
                                        'Fase Stabilisasi: sisa ${controller.stabilizationDaysLeft} hari',
                                        style: TextStyle(
                                          fontSize: 11,
                                          fontWeight: FontWeight.bold,
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              ...
                                              Column(
                                                children: [
                                                  Text(
                                                    'Misal kamu baru aja turun dari BMI Overweight ke Normal. Nah, status "Normal" kamu itu baru dianggap SAH kalau berat badanmu berhasil stabil selama 28 hari berturut-turut!',
                                                    textAlign: TextAlign.center,
                                                    style: TextStyle(height: 1.5, fontSize: 14, color: Colors.grey[800]),
                                                  ),
                                                  const SizedBox(height: 16),
                                                  Container(
                                                    padding: const EdgeInsets.all(12),
                                                    ...
                                                    child: Row(
                                                      ...
                                                      children: [
                                                        ...
                                                        Expanded(
                                                          child: Text(
                                                            'Selama masa stabilisasi ini belum berakhir, target harianmu dikunci dan masih mengikuti batas target sebelumnya (overweight). Artinya, kamu belum bisa sembarangan mengubah target asupan Gula, Kalori, Air Minum, dan Aktivitas Fisik. seperti target MBI "Normal".',
                                              ...
                                              SizedBox(
                                                ...
                                                child: ElevatedButton(
                                                  ...
                                                  child: const Text('Paham!', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
                                                ),
                                              ),
                                            ],
                                          ),
